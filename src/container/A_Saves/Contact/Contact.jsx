...
// saved before making changes to flex/ orientation/style
...
const Contact = () => {
    ...
    {contacts.map((c, index) => (
      <div className='contact__info-box' key={index}>
        ...
        <div className='contact-info__item' key={c.resumePdf.title}>
          ...
          <p className='p-text'>
            <a href={c.resumeUrl} target="_blank" rel="noopener noreferrer">Resume</a>
          </p>
        </div>
  ...
  <div className="footer__copyright">
    <p className="p-text">@2020 Mendez </p>
